...
<div class="vue-ensemble-header">
  ...
  <button onclick="document.getElementById('addForm').style.display='block'; this.style.display='none'" class="btn-action blue btn-new-location">
    <i class="fas fa-plus"></i> Nouveau Lieu
      ...
      <div id="addForm" class="admin-section" style="display:none; padding:2rem; margin-bottom:2rem; background:#fff; border-radius:20px; border:1px solid var(--border); box-shadow:var(--shadow-sm);">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem;">
          <h2 style="margin:0; font-size:1.2rem; font-weight:700;"><i class="fas fa-plus-circle" style="color:var(--accent);"></i> Nouveau Lieu</h2>
          <button onclick="document.getElementById('addForm').style.display='none'; document.querySelector('.btn-new-location').style.display='inline-flex'" class="btn-action gray sm">Fermer</button>
        </div>
        <form method="POST" style="display:grid; grid-template-columns:repeat(auto-fit, minmax(200px, 1fr)); gap:1.5rem; align-items:flex-end;">
          ...
          <button type="submit" class="btn-action blue" style="height:46px; justify-content:center;"><i class="fas fa-save"></i> Enregistrer</button>
        </form>
      </div>
...
.btn-action-icon:hover { background: var(--bg3); }
